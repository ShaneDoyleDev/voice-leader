...
- **Every note sounds.** Placing a note plays it on a sampled grand piano, so you hear the voicing as you build it. Toggle it off from the staff toolbar.
...
The checklist reports in prose. The voice lines show every part's motion; they do not yet pick out the pair that moved in parallel when the checklist finds one.
